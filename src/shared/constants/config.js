...
export const APP_CONFIG = {
  name: "9Router Kyyoa",
  description: "Kyyoa's AI Gateway",
  version: pkg.version,
};

// GitHub configuration
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/Kyyoa/9router-kyyoa/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://9router.com/api/donate",
  repoUrl: "https://github.com/Kyyoa/9router-kyyoa",
  apiRepo: "Kyyoa/9router-kyyoa", // update checks compare the running checkout with this
  branch: "master",
};
