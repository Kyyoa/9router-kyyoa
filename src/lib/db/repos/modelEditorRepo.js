...
function toModel(callName, value) {
  ...
  temperature: value.temperature === "" || value.temperature === null || value.temperature === undefined ? "" : Number(value.temperature),
  topP: value.topP === "" || value.topP === null || value.topP === undefined ? "" : Number(value.topP),
...
export async function setStudioModel({ callName, displayName, targetModel, targetLabel, contextWindow, systemPrompt, temperature, topP, maxTokens }) {
  const payload = {
  callName,
  ...
  temperature: temperature === "" || temperature === null || temperature === undefined ? "" : Number(temperature),
  topP: topP === "" || topP === null || topP === undefined ? "" : Number(topP),
