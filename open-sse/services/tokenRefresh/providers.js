...
// Grok CLI device-code tokens carry the wider grok-cli scope
// (openid profile email offline_access grok-cli:access api:access conversations:read conversations:write)
// + referrer=grok-build at issuance. The plain xAI refresh (no scope, no referrer)
// gets invalid_grant, so grok-cli needs its own refresh body mirroring issuance.
